...
# SpawnResult and TierViolation moved to .result (framework-free) so the
# backend-based runner returns the same types. Re-exported here for
# backward compatibility.
from .result import SpawnResult, TierViolation as _TierViolation  # noqa: E402
