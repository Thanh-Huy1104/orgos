...
if TYPE_CHECKING:  # runtime import stays deferred to avoid a circular ref
    from .contracts import RoleSpec  # noqa: F401
...
def load_agent(agents_root: Path, agent_name: str) -> "RoleSpec":
    ...
    from .contracts import PermissionTier, RoleSpec
