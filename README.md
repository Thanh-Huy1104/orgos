...
**Reference docs:**
- **[docs/architecture.html](docs/architecture.html)** — how the two layers (agile team + spawn/governance) fit together, with diagrams
...
- **[docs/spawn-rubric.md](docs/spawn-rubric.md)** — governance-layer deep dive (permission tiers, audit, rubric-graded retry)
